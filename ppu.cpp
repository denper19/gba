...
void Lcd::DrawFrame()
{
	...
	//surface = SDL_CreateRGBSurfaceWithFormat(0, width, height, 32, SDL_PIXELFORMAT_ABGR1555);
	//if (surface == NULL)
	//{
	//	SDL_Log("SDL_CreateRGBSurfaceWithFormat() failed: %s", SDL_GetError());
	//}
	//SDL_ConvertPixels(width, height, SDL_PIXELFORMAT_ABGR1555, pixels.data(), 0, SDL_PIXELFORMAT_ABGR1555, surface, 0);
